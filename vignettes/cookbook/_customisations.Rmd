...
`theme_sg()` has arguments to control the legend position and appearance of grid lines, axis lines and axis ticks. More information on accepted values can be found in the [help file](https://datasciencescotland.github.io/sgplot/reference/theme_sg.html).
...
gapminder |>
  ...
  geom_hline(yintercept = 75, colour = sg_colour_values["orange"],
