...
* `main2` should be used if only two colours are required as the dark blue and orange colours have the best colour contrast. If only two colour are required and another palette is used, a warning message will appear to advise you use `main2`.
