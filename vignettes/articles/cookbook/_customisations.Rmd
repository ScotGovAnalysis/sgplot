...
```{r before-customisation, fig.alt = "A horizontal bar chart using sgplot theme and dark blue colour."}
bar_data |>
...
```{r sorting, fig.alt = "A horizontal bar chart using sgplot theme and dark blue colour with bars sorted in decreasing order by population."}
bar_data |>
...
```{r chart-titles, fig.alt = "A bar chart with title, subtitle and caption. The axis titles have been removed. The main title is too long and the end is cut off."}
last_plot() +
  labs(
    x = NULL,
    y = NULL,
...
```{r text-wrap-1, fig.alt = "A bar chart with main title and y-axis title text wrapped onto two lines."}
last_plot() +
  labs(
...
```{r text-wrap-2, fig.alt = "A bar chart with main title and y-axis title text wrapped onto two lines."}
last_plot() +
  labs(
...
```{r expand, fig.alt = "A bar chart with no space between bottom of bars and x-axis."}
last_plot() +
...
```{r axis-limits-breaks-labels, fig.alt = "A bar chart with more x-axis breaks and formatted labels. The last label is suffixed with 'million'."}
last_plot() +
  scale_x_continuous(expand = c(0, 0),
                     limits = c(0, 3e8 * 1.1),
...
```{r scales-pkg, fig.alt = "A bar chart with fewer x-axis breaks and labels formatted with comma thousands separators."}
last_plot() +
  scale_x_continuous(expand = c(0, 0),
                     limits = c(0, 3e8 * 1.1),
...
```{r adjust-theme, fig.alt = "A bar chart using sgplot theme and dark blue colour, with y-axis lines and ticks coloured black."}
last_plot() +
...
```{r clip-1, fig.height = 5.5, fig.alt = "A stacked bar chart with top gridline is half the width of the adjoining tick mark and other grid lines."}
stacked_bar_data |>
...
```{r clip-2, fig.height = 5.5, fig.alt = "A stacked bar chart with top gridline the same width as adjoining tick mark and other grid lines."}
last_plot() +
...
```{r add-a-line, fig.alt = "A line chart with dashed, grey horizontal line at age 75."}
gapminder |>
